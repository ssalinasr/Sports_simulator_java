 ...
 * @author Salinas
 */
public class FrameEliminationGames extends javax.swing.JFrame {
    ...
    public void setComboGamesValue(String sport) {
        this.ComboGames.getModel().setSelectedItem(sport);
    }
   ...
   public ArrayList<String> getComboTeamsValues(){
       ArrayList<String> teams = new ArrayList<>();
       for(int i = 0 ;i < this.ComboTeams.getItemCount(); i++){
           teams.add(ComboTeams.getItemAt(i));
       }
       return teams;
   }
    ...
    public void generateRandom() {
        String value = (String) this.ComboGames.getSelectedItem();
                    ...
                    while (counter < 4) {
                        ...
                        for (int k = 0; k < selected_teams.size(); k += 2) {
                            try {
                                switch (sport) {
                                    case "GE-Lives":
                                        this.ol = new FrameGames("GE-Lives", this.selected_teams.get(k).getName(), this.selected_teams.get(k + 1).getName());
                                        this.ol.autoExecution();
                                        break;
                                    case "GE-License to Kill":
                                        this.ol = new FrameGames("GE-License to Kill", this.selected_teams.get(k).getName(), this.selected_teams.get(k + 1).getName());
                                        this.ol.autoExecution();
                                        break;
                                    case "GE-Time":
                                        this.ol = new FrameGames("GE-Time", this.selected_teams.get(k).getName(), this.selected_teams.get(k + 1).getName());
                                        this.ol.autoExecution();
                                        break;
                                    case "GE-SSDV":
                                        this.ol = new FrameGames("GE-SSDV", this.selected_teams.get(k).getName(), this.selected_teams.get(k + 1).getName());
                                        this.ol.autoExecution();
                                        break;
                                    case "GE-Teams":
                                        this.ol = new FrameGames("GE-Teams", this.selected_teams.get(k).getName(), this.selected_teams.get(k + 1).getName());
                                        this.ol.autoExecution();
                                        break;
                                    case "MK-Battles":
                                        this.ol = new FrameGames("MK-Battles", this.selected_teams.get(k).getName(), this.selected_teams.get(k + 1).getName());
                                        this.ol.autoExecution();
                                        break;
                                    case "SSB-Time":
                                        this.ol = new FrameGames("SSB-Time", this.selected_teams.get(k).getName(), this.selected_teams.get(k + 1).getName());
                                        this.ol.autoExecution();
                                        break;
                                    case "SSB-Lives":
                                        this.ol = new FrameGames("SSB-Lives", this.selected_teams.get(k).getName(), this.selected_teams.get(k + 1).getName());
                                        this.ol.autoExecution();
                                        break;
                                    case "SSB-Coins":
                                        this.ol = new FrameGames("SSB-Coins", this.selected_teams.get(k).getName(), this.selected_teams.get(k + 1).getName());
                                        this.ol.autoExecution();
                                        break;
                                    case "SSB-Stamina":
                                        this.ol = new FrameGames("SSB-Stamina", this.selected_teams.get(k).getName(), this.selected_teams.get(k + 1).getName());
                                        this.ol.autoExecution();
                                        break;
    ...
    private void initComponents() {
        ...
        LblSport.setText("Game");

        ComboGames.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "<Select Game>", "GE-Time", "GE-Lives", "GE-License to Kill", "GE-SSDV", "GE-Teams", "MK-Battles", "SSB-Time", "SSB-Lives", "SSB-Coins", "SSB-Stamina" }));
    ...
    private void BtnThirdPlaceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnThirdPlaceActionPerformed
        try {
            ...
            switch (sport) {
                case "GE-Lives":
                    this.ol = new FrameGames("GE-Lives", third_teams.get(0).getName(), third_teams.get(1).getName());
                    this.ol.autoExecution();
                    break;
                case "GE-License to Kill":
                    this.ol = new FrameGames("GE-License to Kill", third_teams.get(0).getName(), third_teams.get(1).getName());
                    this.ol.autoExecution();
                    break;
                case "GE-Time":
                    this.ol = new FrameGames("GE-Time", third_teams.get(0).getName(), third_teams.get(1).getName());
                    this.ol.autoExecution();
                    break;
                case "GE-SSDV":
                    this.ol = new FrameGames("GE-SSDV", third_teams.get(0).getName(), third_teams.get(1).getName());
                    this.ol.autoExecution();
                    break;
                case "GE-Teams":
                    this.ol = new FrameGames("GE-Teams", third_teams.get(0).getName(), third_teams.get(1).getName());
                    this.ol.autoExecution();
                    break;
                case "MK-Battles":
                    this.ol = new FrameGames("MK-Battles", third_teams.get(0).getName(), third_teams.get(1).getName());
                    this.ol.autoExecution();
                    break;
                case "SSB-Time":
                    this.ol = new FrameGames("SSB-Time", third_teams.get(0).getName(), third_teams.get(1).getName());
                    this.ol.autoExecution();
                    break;
                case "SSB-Lives":
                    this.ol = new FrameGames("SSB-Lives", third_teams.get(0).getName(), third_teams.get(1).getName());
                    this.ol.autoExecution();
                    break;
                case "SSB-Coins":
                    this.ol = new FrameGames("SSB-Coins", third_teams.get(0).getName(), third_teams.get(1).getName());
                    this.ol.autoExecution();
                    break;
                case "SSB-Stamina":
                    this.ol = new FrameGames("SSB-Stamina", third_teams.get(0).getName(), third_teams.get(1).getName());
                    this.ol.autoExecution();
                    break;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameEliminationGames.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameEliminationGames().setVisible(true);
            }
        });
    }
