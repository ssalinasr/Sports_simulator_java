...
import Interfaces.Sports.CitiesFootballInterface;
...
import Modules.*;
import OlympicGames.FrameCities;
 ...
 * @author Flia_Salinas
 */
public class ManyMatchesCities extends javax.swing.JFrame {
    ...
    private CitiesFootballInterface footc;
    ...
    public ManyMatchesCities() {
        ...
        this.footc = new CitiesFootballInterface();
        this.database = this.footc.getDatabaseValues();
    ...
    private void initComponents() {
        ...
        PanelActions.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED), "Actions", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        PanelResultsLayout.setHorizontalGroup(
            ...
            .addGroup(PanelResultsLayout.createSequentialGroup()
                ...
                .addGroup(PanelResultsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(PanelResultsLayout.createSequentialGroup()
                        .addComponent(BtnGroup, javax.swing.GroupLayout.PREFERRED_SIZE, 191, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(BtnGenGroups, javax.swing.GroupLayout.PREFERRED_SIZE, 191, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
    ...
    private void BtnMatchesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnMatchesActionPerformed
        try {
            ...
            for (String f : fix_split) {
                ...
                switch (sport) {
                    case "Cities Football":
                        this.ol = new FrameCities("Cities Football", team1, team2);
    ...
    private void BtnRandomActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRandomActionPerformed
        ...
        this.modlist.clear();
        CitiesFootballInterface footc = new CitiesFootballInterface();
        ArrayList<Team> tempTeams = footc.getDatabaseValues();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManyMatchesCities.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManyMatchesCities().setVisible(true);
            }
        });
    }
