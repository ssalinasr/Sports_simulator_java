 ...
 * @author Salinas
 */
public class FrameEliminationCities extends javax.swing.JFrame {
                            ...
                            try {
                                switch (sport) {
                                    case "Cities Football":
                                        this.ol = new FrameCities("Cities Football", this.selected_teams.get(k).getName(), this.selected_teams.get(k + 1).getName(), true);
                    ...
                    while (counter < 5) {
                        ...
                        for (int k = 0; k < selected_teams.size(); k += 2) {
                            try {
                                switch (sport) {
                                    case "Cities Football":
                                        this.ol = new FrameCities("MenFootball", this.selected_teams.get(k).getName(), this.selected_teams.get(k + 1).getName(), true);
                                        this.ol.autoExecution();
                                        break;
                                }
    ...
    private void BtnThirdPlaceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnThirdPlaceActionPerformed
        try {
            ...
            switch (sport) {
                case "Cities Football":
                    this.ol = new FrameCities("MenFootball", third_teams.get(0).getName(), third_teams.get(1).getName(), true);
                    this.ol.autoExecution();
                    break;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameEliminationCities.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameEliminationCities().setVisible(true);
            }
        });
    }
