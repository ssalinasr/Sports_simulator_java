 ...
 * @author Salinas
 */
public class FrameClubs extends javax.swing.JFrame {
    ...
    public FrameClubs() {
        ...
        try {
            ...
            for (String s : leagues) {
                this.TxtLeagueTeam1.addItem(s);
                this.TxtLeagueTeam2.addItem(s);
            }
     ...
     * @param lg2
     */
    public FrameClubs(String sport, String tn1, String tn2, String lg1, String lg2) {
        initComponents();
        setLocationRelativeTo(null);
        setResizable(false);
        setTitle("Club Matches");
        ...
        this.TxtLeagueTeam1.setSelectedItem(lg1);
        this.TxtLeagueTeam2.setSelectedItem(lg2);
     ...
     * @param lg2
     */
    public FrameClubs(String sport, String tn1, String tn2, String lg1, String lg2, boolean TE) {
        initComponents();
        setLocationRelativeTo(null);
        setResizable(false);
        setTitle("Club Matches");
    ...
    private void initComponents() {
        ...
        TxtLeagueTeam1 = new javax.swing.JComboBox<>();
        TxtLeagueTeam2 = new javax.swing.JComboBox<>();
        ...
        PanelTime.setBackground(new java.awt.Color(0, 51, 51));
        ...
        TxtLeagueTeam1.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        TxtLeagueTeam1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "<Select league>" }));
        TxtLeagueTeam1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TxtLeagueTeam1ActionPerformed(evt);
            }
        });

        TxtLeagueTeam2.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        TxtLeagueTeam2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "<Select league>" }));
        TxtLeagueTeam2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TxtLeagueTeam2ActionPerformed(evt);
            }
        });
        ...
        PanelMarkLayout.setHorizontalGroup(
            ...
            .addGroup(PanelMarkLayout.createSequentialGroup()
                .addGroup(PanelMarkLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(PanelMarkLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(TxtLeagueTeam1, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 193, Short.MAX_VALUE)
                        .addComponent(TxtLeagueTeam2, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        PanelMarkLayout.setVerticalGroup(
            ...
            .addGroup(PanelMarkLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(PanelMarkLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(TxtLeagueTeam2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(TxtLeagueTeam1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(PanelMarkLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        PanelHistory.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED), "History", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Corbel Light", 1, 12), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        PanelChecksLayout.setHorizontalGroup(
            ...
            .addGroup(PanelChecksLayout.createSequentialGroup()
                ...
                .addGroup(PanelChecksLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(CheckDoubleR, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 170, Short.MAX_VALUE)
                    .addComponent(CheckTE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(CheckLoc, javax.swing.GroupLayout.DEFAULT_SIZE, 170, Short.MAX_VALUE))
                .addContainerGap())
        );
        PanelChecksLayout.setVerticalGroup(
            ...
            .addGroup(PanelChecksLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(CheckTE, javax.swing.GroupLayout.PREFERRED_SIZE, 19, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        PanelButtons.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED), "History", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Corbel Light", 1, 12), new java.awt.Color(255, 255, 255))); // NOI18N
    ...
    private void TxtLeagueTeam2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TxtLeagueTeam2ActionPerformed
        this.TxtNameTeam2.removeAllItems();
        String league = (String) this.TxtLeagueTeam2.getSelectedItem();
        ArrayList<Team> aux = this.footm.getDatabaseValues(league);

        for (Team tm : aux) {
            if (!this.database.contains(tm)) {
                this.database.add(tm);
                this.TxtNameTeam2.addItem(tm.getName());
            }
        }
    }//GEN-LAST:event_TxtLeagueTeam2ActionPerformed

    private void TxtLeagueTeam1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TxtLeagueTeam1ActionPerformed
        this.TxtNameTeam1.removeAllItems();
        String league = (String) this.TxtLeagueTeam1.getSelectedItem();
        ArrayList<Team> aux = this.footm.getDatabaseValues(league);

        for (Team tm : aux) {
            if (!this.database.contains(tm)) {
                this.database.add(tm);
                this.TxtNameTeam1.addItem(tm.getName());
            }
        }

    }//GEN-LAST:event_TxtLeagueTeam1ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameClubs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameClubs().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox<String> TxtLeagueTeam1;
    private javax.swing.JComboBox<String> TxtLeagueTeam2;
