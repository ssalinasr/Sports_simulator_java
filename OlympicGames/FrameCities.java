 ...
 * @author Salinas
 */
public class FrameCities extends javax.swing.JFrame {

    public CitiesFootballInterface footc;
     ...
     * @param sport
     */
    public FrameCities(String sport, String tn1, String tn2) {
        initComponents();
        setLocationRelativeTo(null);
        setResizable(false);
        setTitle("Olympic Matches");
     ...
     * @param sport
     */
    public FrameCities(String sport, String tn1, String tn2, boolean TE) {
        initComponents();
        setLocationRelativeTo(null);
        setResizable(false);
        setTitle("Olympic Matches");
    ...
    public void runMatch() throws InterruptedException {
        ...
        System.out.println(this.currentTeam1.getName() + "-" + this.currentTeam2.getName());

        this.timeelapsed = 90;
        if (!this.CheckDoubleR.isSelected()) {

            this.footc.getDifference(this.currentTeam1, this.currentTeam2);
            if (this.CheckLoc.isSelected()) {
                this.footc.getLocalBuff(this.currentTeam1, this.currentTeam2);
            }

            this.footc.goalsInstantMatch(this.timeelapsed, this.currentTeam1, this.currentTeam2,
            ...
            if ((this.currentTeam1.getGoalsteam() == this.currentTeam2.getGoalsteam()) && this.CheckTE.isSelected()) {
                this.footc.penaltiesMethod(GoalPTeam1, GoalPTeam2, currentTeam1, currentTeam2, MatchArea);
            }
        ...
        PanelChecksLayout.setHorizontalGroup(
            ...
            .addGroup(PanelChecksLayout.createSequentialGroup()
                ...
                .addGroup(PanelChecksLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(CheckShield, javax.swing.GroupLayout.DEFAULT_SIZE, 82, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(PanelChecksLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(CheckDoubleR, javax.swing.GroupLayout.DEFAULT_SIZE, 82, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameCities.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameCities().setVisible(true);
            }
        });
    }
