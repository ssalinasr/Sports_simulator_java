 ...
 * @author Salinas
 */
public class WomenFutsalInterface implements MainInterface {

    public GUITools tools;

    public WomenFutsalInterface() {
