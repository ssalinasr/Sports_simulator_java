 ...
 * @author Salinas
 */
public class HockeyInterface implements MainInterface {

    public GUITools tools;

    public HockeyInterface() {
    ...
    public void generateRandomInstance(double difTeam, double sucessProb, Team team, int id,
        ...
        if (goal_Case == 1) {
            team.setGoalsteam(team.getGoalsteam() + (1+(int) Math.floor(Math.random()*3)));
    ...
    public void goalsInstantMatch(double timeelapsed, Team team1, Team team2, JCheckBox CheckTE,
        ...
        while (counter < timeelapsed) {
            ...
            if((counter == (timeelapsed)) && (team1.getGoalsteam() == team2.getGoalsteam()) && (counter < 80)){
                timeelapsed += 10;
            }
            if(counter%20 == 0){
