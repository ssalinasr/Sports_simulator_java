 ...
 * @author Salinas
 */
public class RugbyInterface implements MainInterface {

    public GUITools tools;

    public RugbyInterface() {
    ...
    public void generateRandomInstance(double difTeam, double sucessProb, Team team, int id,
        ...
        if (goal_Case == 1) {
            ...
            switch (r) {
                case 0:
                    team.setGoalsteam(team.getGoalsteam() + 2);
                    break;
                case 1:
                    int m = (int) Math.floor(Math.random() * 5);
                    if (m == 2) {
                        team.setGoalsteam(team.getGoalsteam() + 3);
                    }
                    break;
                case 2:
                    team.setGoalsteam(team.getGoalsteam() + 5);
                    break;
                case 3:
                    int q = (int) Math.floor(Math.random() * 10);
                    if (q == 5) {
    ...
    public void goalsInstantMatch(double timeelapsed, Team team1,
        ...
        while (counter < timeelapsed) {
            ...
            if ((counter == (timeelapsed - 2)) && (team1.getGoalsteam() == team2.getGoalsteam()) && timeelapsed < 110) {
                timeelapsed += 10;
            }
            if (counter == 40) {
