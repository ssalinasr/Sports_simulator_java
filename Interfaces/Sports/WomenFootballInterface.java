 ...
 * @author Salinas
 */
public class WomenFootballInterface implements MainInterface {

    public GUITools tools;

    public WomenFootballInterface() {
