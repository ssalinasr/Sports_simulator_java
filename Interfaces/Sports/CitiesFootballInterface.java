 ...
 * @author Salinas
 */
public class CitiesFootballInterface implements MainInterface {

    public GUITools tools;

    public CitiesFootballInterface() {
    ...
    public void goalsInstantMatch(double timeelapsed, Team team1, Team team2, JCheckBox CheckTE,
        ...
        while (counter < timeelapsed) {
            ...
            if (isDoubleRound && counter == 89 && (team1.getGoalsteam() == team2.getGoalsteam()) && gcounter == 2) {
