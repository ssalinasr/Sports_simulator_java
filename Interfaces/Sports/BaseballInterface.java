 ...
 * @author Salinas
 */
public class BaseballInterface implements MainInterface {

    public GUITools tools;

    public BaseballInterface() {
    ...
    public void goalsInstantMatch(double timeelapsed, Team team1, Team team2, JCheckBox CheckTE,
        ...
        while (counter < timeelapsed) {
            ...
            if((counter == (timeelapsed)) && (team1.getGoalsteam() == team2.getGoalsteam())){
                timeelapsed += 10;
            }
            if(counter%10 == 0){
                tools.putTime(Match1);
            }
            counter++;
        }
