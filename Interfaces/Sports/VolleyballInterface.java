 ...
 * @author Salinas
 */
public class VolleyballInterface implements MainInterface {

    public GUITools tools;

    public VolleyballInterface() {
    ...
    public void goalsInstantMatch(double timeelapsed, Team team1, Team team2, JCheckBox CheckTE,
        ...
        while (true) {
            ...
            if (((team1.getGoalsteam() > 25 || team2.getGoalsteam() > 25) || (team1.getGoalsteam() > 24 && team2.getGoalsteam() - team1.getGoalsteam() < 2))) {
                break;
            }
        }
