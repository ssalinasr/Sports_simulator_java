 ...
 * @author Salinas
 */
public class HandballInterface implements MainInterface {

    public GUITools tools;

    public HandballInterface() {
    ...
    public void goalsInstantMatch(double timeelapsed, Team team1,
        ...
        while (counter < timeelapsed) {
            ...
            if ((counter == (timeelapsed)) && (team1.getGoalsteam() == team2.getGoalsteam()) && timeelapsed < 110) {
                timeelapsed += 10;
            }
            if (counter == 30) {
