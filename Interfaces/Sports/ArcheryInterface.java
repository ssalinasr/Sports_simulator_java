 ...
 * @author Salinas
 */
public class ArcheryInterface implements MainInterface {

    public GUITools tools;

    public ArcheryInterface() {
    ...
    public void generateRandomInstance(double difTeam, double sucessProb, Team team, int id,
        ...
        if (goal_Case == 1) {
            ...
            switch (r) {
                case 0:
                    team.setGoalsteam(team.getGoalsteam() + 6);
                    break;
                case 1:
                    team.setGoalsteam(team.getGoalsteam() + 7);
                    break;
                case 2:
                    team.setGoalsteam(team.getGoalsteam() + 8);
                    break;
                case 3:
                    team.setGoalsteam(team.getGoalsteam() + 9);
                    break;
                case 4:
                    team.setGoalsteam(team.getGoalsteam() + 10);
                    break;
    ...
    public void goalsInstantMatch(double timeelapsed, Team team1, Team team2, JCheckBox CheckTE,
        ...
        while (true) {
            ...
            if ((((team1.getGoalsteam() > 25 && team1.getGoalsteam() <= 35) || (team2.getGoalsteam() > 25 && team2.getGoalsteam() <= 35)))) {
                if (team1.getGoalsteam() > 30) {
                    team1.setGoalsteam(30);
                }
                if (team2.getGoalsteam() > 30) {
                    team2.setGoalsteam(30);
                }
                break;
            }
        }
