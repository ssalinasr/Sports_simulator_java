 ...
 * @author Salinas
 */
public class MenFootballInterface implements MainInterface {

    public GUITools tools;

    public MenFootballInterface() {
    ...
    public void goalsInstantMatch(double timeelapsed, Team team1, Team team2, JCheckBox CheckTE,
        ...
        while (counter < timeelapsed) {
            ...
            //System.out.println(team1.getGlobalgoalsteam() + " - "+ team2.getGlobalgoalsteam());
