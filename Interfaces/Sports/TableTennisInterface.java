 ...
 * @author Salinas
 */
public class TableTennisInterface implements MainInterface {

    public GUITools tools;

    public TableTennisInterface() {
    ...
    public void goalsInstantMatch(double timeelapsed, Team team1, Team team2, JCheckBox CheckTE,
        ...
        while (true) {
            ...
            if ((team1.getGoalsteam() > 11 || team2.getGoalsteam() > 11) || (team1.getGoalsteam() > 10 && team2.getGoalsteam() - team1.getGoalsteam() < 2)) {
                break;
            }
        }
