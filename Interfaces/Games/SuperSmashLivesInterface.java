 ...
 * @author Salinas
 */
public class SuperSmashLivesInterface implements MainInterface {
    
    public GUITools tools;
    
    public SuperSmashLivesInterface(){
    ...
    public ArrayList<Team> getDatabaseValues() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                TeamPlayer tm = new TeamPlayer(n, d, 0.0, b, b, "lives");
                database.add(tm);
    ...
    public void goalsInstantMatch(double timeelapsed, Team team1, Team team2, JCheckBox CheckTE,
        ...
        while (true) {
            ...
            if ((team1.getGoalsteam() < 0 || team2.getGoalsteam() < 0)) {
                break;
            }
        }
