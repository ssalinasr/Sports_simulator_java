 ...
 * @author Salinas
 */
public class MarioKartBattlesInterface implements MainInterface {
    
    public GUITools tools;
    
    public MarioKartBattlesInterface(){
    ...
    public ArrayList<Team> getDatabaseValues() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                TeamPlayer tm = new TeamPlayer(n, d, 0.0, b, b, "kart");
                database.add(tm);
