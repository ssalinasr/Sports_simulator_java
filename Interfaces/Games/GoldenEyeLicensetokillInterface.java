 ...
 * @author Salinas
 */
public class GoldenEyeLicensetokillInterface implements MainInterface {
    
    public GUITools tools;
    
    public GoldenEyeLicensetokillInterface(){
    ...
    public void goalsInstantMatch(double timeelapsed, Team team1, Team team2, JCheckBox CheckTE,
        ...
        while (true) {
            ...
            if ((team1.getGoalsteam() > 10 || team2.getGoalsteam() > 10)) {
                break;
            }
        }
