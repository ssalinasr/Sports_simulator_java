 ...
 * @author Salinas
 */
public class FrameMuns extends javax.swing.JFrame {

    public MunsHockeyInterface munh;
    public MunsTournamentsInterface munt;
    ...
    public FrameMuns() {
        ...
        this.munt = new MunsTournamentsInterface();
     ...
     * @param tn2
     */
    public FrameMuns(String sport, String tn1, String tn2) {
        initComponents();
        setLocationRelativeTo(null);
        setResizable(false);
        ...
        try {
            ...
            for (Team t : this.database) {
                if (t.getName().equals(teamname)) {
                    route_e = "/banderas/blank.jpg";
                    route_b = "/banderas/blank.jpg";
                    break;
                }
            }
            flagSorter s;
    ...
    public void runMatch() throws InterruptedException {
        ...
        switch (value) {
            ...
            case "Hockey en Piso":
                this.timeelapsed = 450;
                this.munh.goalsInstantMatch(this.timeelapsed, this.currentTeam1, this.currentTeam2,
            ...
            default:
                this.munt.goalsInstantMatch(this.timeelapsed, this.currentTeam1, this.currentTeam2,
                        this.CheckTE, this.CheckDoubleR.isSelected(), this.auto, this.duration,
                        this.MatchArea, this.GoalTeam1, this.GoalTeam2, this.BarTime, 0);
                this.goals[0] = "" + this.currentTeam1.getGoalsteam();
                this.goals[1] = "" + this.currentTeam2.getGoalsteam();
    ...
    private void initComponents() {
        ...
        ComboBoxGames.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "<Select Game>", "Jenga", "Ajedrez", "Domino", "Parques", "Horripicasa", "Lucha", "Hockey en Piso", "Futbol", "Baloncesto" }));
    ...
    private void ComboBoxGamesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ComboBoxGamesActionPerformed
        ...
        String sport = (String) this.ComboBoxGames.getSelectedItem();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameMuns.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
